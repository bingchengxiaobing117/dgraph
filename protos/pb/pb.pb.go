...
type Result struct {
	UidMatrix            map[uint64]*UidPack   `protobuf:"bytes,1,rep,name=uid_matrix,json=uidMatrix,proto3" json:"uid_matrix,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ValueMatrix          map[uint64]*ValueList `protobuf:"bytes,2,rep,name=value_matrix,json=valueMatrix,proto3" json:"value_matrix,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Counts               map[uint64]uint32     `protobuf:"bytes,3,rep,name=counts,proto3" json:"counts,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	IntersectDest        bool                  `protobuf:"varint,4,opt,name=intersect_dest,json=intersectDest,proto3" json:"intersect_dest,omitempty"`
	FacetMatrix          map[uint64]*FacetsMap `protobuf:"bytes,5,rep,name=facet_matrix,json=facetMatrix,proto3" json:"facet_matrix,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	LangMatrix           map[uint64]*LangList  `protobuf:"bytes,6,rep,name=lang_matrix,json=langMatrix,proto3" json:"lang_matrix,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
func (m *Result) GetUidMatrix() map[uint64]*UidPack {
	if m != nil {
		return m.UidMatrix
	}
	return nil
...
func (m *Result) GetValueMatrix() map[uint64]*ValueList {
	if m != nil {
...
func (m *Result) GetCounts() map[uint64]uint32 {
	if m != nil {
		return m.Counts
	}
	return nil
...
func (m *Result) GetFacetMatrix() map[uint64]*FacetsMap {
	if m != nil {
...
func (m *Result) GetLangMatrix() map[uint64]*LangList {
	if m != nil {
		return m.LangMatrix
	}
	return nil
...
type FacetsMap struct {
	Facets               map[uint64]*Facets `protobuf:"bytes,1,rep,name=facets,proto3" json:"facets,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}           `json:"-"`
	XXX_unrecognized     []byte             `json:"-"`
	XXX_sizecache        int32              `json:"-"`
}

func (m *FacetsMap) Reset()         { *m = FacetsMap{} }
func (m *FacetsMap) String() string { return proto.CompactTextString(m) }
func (*FacetsMap) ProtoMessage()    {}
func (*FacetsMap) Descriptor() ([]byte, []int) {
	return fileDescriptor_f80abaa17e25ccc8, []int{33}
}
func (m *FacetsMap) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *FacetsMap) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FacetsMap.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FacetsMap) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FacetsMap.Merge(m, src)
}
func (m *FacetsMap) XXX_Size() int {
	return m.Size()
}
func (m *FacetsMap) XXX_DiscardUnknown() {
	xxx_messageInfo_FacetsMap.DiscardUnknown(m)
}

var xxx_messageInfo_FacetsMap proto.InternalMessageInfo

func (m *FacetsMap) GetFacets() map[uint64]*Facets {
	if m != nil {
		return m.Facets
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[uint64]uint32)(nil), "pb.Result.CountsEntry")
	proto.RegisterMapType((map[uint64]*FacetsMap)(nil), "pb.Result.FacetMatrixEntry")
	proto.RegisterMapType((map[uint64]*LangList)(nil), "pb.Result.LangMatrixEntry")
	proto.RegisterMapType((map[uint64]*UidPack)(nil), "pb.Result.UidMatrixEntry")
	proto.RegisterMapType((map[uint64]*ValueList)(nil), "pb.Result.ValueMatrixEntry")
	...
	proto.RegisterType((*FacetsMap)(nil), "pb.FacetsMap")
	proto.RegisterMapType((map[uint64]*Facets)(nil), "pb.FacetsMap.FacetsEntry")
...
var fileDescriptor_f80abaa17e25ccc8 = []byte{
	...
	,
}
...
func (m *FacetsMap) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *FacetsMap) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *FacetsMap) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *BackupPostingList) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Splits) > 0 {
		dAtA38 := make([]byte, len(m.Splits)*10)
		var j37 int
		for _, num := range m.Splits {
			for num >= 1<<7 {
	...
	if len(m.Uids) > 0 {
		dAtA40 := make([]byte, len(m.Uids)*10)
		var j39 int
...
func (m *Result) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.UidMatrix == nil {
				m.UidMatrix = make(map[uint64]*UidPack)
			}
			var mapkey uint64
			var mapvalue *UidPack
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 2:
			...
			if m.ValueMatrix == nil {
				m.ValueMatrix = make(map[uint64]*ValueList)
			}
			var mapkey uint64
			var mapvalue *ValueList
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 5:
			...
			if m.FacetMatrix == nil {
				m.FacetMatrix = make(map[uint64]*FacetsMap)
			}
			var mapkey uint64
			var mapvalue *FacetsMap
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
		...
		case 6:
			...
			if m.LangMatrix == nil {
				m.LangMatrix = make(map[uint64]*LangList)
			}
			var mapkey uint64
			var mapvalue *LangList
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
...
func (m *FacetsMap) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FacetsMap: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FacetsMap: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.Facets == nil {
				m.Facets = make(map[uint64]*Facets)
			}
			var mapkey uint64
			var mapvalue *Facets
			for iNdEx < postIndex {
